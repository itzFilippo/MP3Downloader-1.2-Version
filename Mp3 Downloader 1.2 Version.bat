...
@echo 30: Ikson - Waves
@echo 31: Ikson - Contact
@echo 32: Ikson - Breeze
@echo 33: Ikson - Mon Paris
@echo 34: Ikson - Questions
@echo 35: Ikson - Paradise
@echo 36: Ikson - Til Next Time
@echo 37: Ikson - Coral
@echo 38: Ikson - Orbit
@echo 39: Ikson - Contigo
@echo 40: Ikson - Sunflower
set /p song= %=%
...
if [%song%]==[29] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/849730087422525440/Ikson_-_Good_Day_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Good Days.mp3') }" & cls & echo Downloaded & pause & exit
...
if [%song%]==[31] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852481882725679134/Ikson_-_Contact_Official1.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Contact.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[32] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852482413481164840/Ikson_-_Breeze_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Breeze.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[33] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852482829358858240/Ikson_-_Mon_Paris_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Mon Paris.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[34] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852483991931715624/Ikson_-_Questions_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Questions.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[35] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852484708515184670/Ikson_-_Paradise_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Paradise.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[36] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852485124008050689/Ikson_-_Til_Next_Time_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Til Next Time.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[37] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852485600639844362/Ikson_-_Coral_Chill_Beat.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Coral.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[38] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852485929415344128/Ikson_-_Orbit_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Orbit.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[39] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852486395281145856/Ikson_-_Contigo_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Contigo.mp3') }" & cls & echo Downloaded & pause & exit
if [%song%]==[40] powershell -command "& { (New-Object Net.WebClient).DownloadFile('https://cdn.discordapp.com/attachments/758694549848588302/852486798931918868/Ikson_-_Sunflower_Official.mp3', 'C:\Users\%username%\Documents\Music\Ikson - Sunflower.mp3') }" & cls & echo Downloaded & pause & exit
